  ...
  return (
    <div className="mt-4">
      ...
      <Div className="flex flex-col mt-4 w-1/2 bg-gray-200">
        ...
        <Div className="mt-2">
          <Subtitle>flex-row flex-wrap-reserve</Subtitle>
          <Div className="flex flex-row flex-wrap-reserve p-4">{boxes}</Div>
        </Div>
        <Div className="mt-2">
          <Subtitle>flex-row flex-wrap</Subtitle>
      ...
      <Div className="flex flex-row mt-4  bg-gray-200">
        ...
        <Div className="mr-8">
          <Subtitle>flex-column flex-wrap-reserve</Subtitle>
          <Div className="flex flex-col flex-wrap-reserve p-4 h-40 min-h-40">{boxes}</Div>
        </Div>
        <Div className="mr-8">
